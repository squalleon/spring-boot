...
public class PassService {
     ...
     * @throws Exception
     */
    public HashMap<String, Object> callPassService(HttpServletRequest request
        ...
        try {
            ...
            if ("L".equals(chkServer) || "D".equals(chkServer) || "Q".equals(chkServer)) {
                ...
                passToken = globalsProperties.getProperty("Globals.pass.token.prd");
            ...
            headers.add("Authorization", "Bearer " + passToken);
            ...
            ResponseEntity<?> responseEntity = restTemplate.exchange(passCallDomain + API_ENDPOINT, (HttpMethod) httpMethodObj, requestEntity, REQ_MAP.getClass());
